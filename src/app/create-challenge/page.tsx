...
export const metadata: Metadata = {
  title: "Start a Business Challenge | Creator Challenge Network",
  description:
    "Describe a business problem and open it for globally sourced solutions with test USDC secured on Arc Testnet.",
};
    ...
    return (
      <main className="min-h-screen bg-[#050916] px-6 py-10 text-white">
        <div className="mx-auto max-w-2xl rounded-3xl border border-white/10 bg-[#0c1222] p-8">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-cyan-200">Start a Business Challenge</p>
