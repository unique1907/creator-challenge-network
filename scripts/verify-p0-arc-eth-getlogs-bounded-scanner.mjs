...
assert.ok(fundingAction.indexOf('circleFetch<CircleContractExecutionResponse>') < fundingAction.indexOf("await persistFundingAttempt"), "funding attempt persistence must stay after Circle returns a funding challenge");
